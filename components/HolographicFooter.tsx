...
export default function HolographicFooter() {
    ...
    const contacts = [
        {
            name: "Instagram",
            href: "https://instagram.com/daivik_warrior",
            icon: (
    ...
    return (
        <footer className="relative min-h-[60vh] bg-[#050505] overflow-hidden">
            ...
            <div className="relative z-10 h-full flex flex-col items-center justify-center py-20 px-6">
                ...
                <motion.div
                    ...
                    className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 max-w-3xl w-full"
                >
                    {contacts.map((contact) => (
                        <a
                            ...
                            className="group flex flex-col items-center gap-3 p-6 bg-white/[0.03] backdrop-blur-sm border border-white/[0.08] rounded-2xl hover:bg-white/[0.08] hover:border-white/[0.15] transition-all duration-300"
                        >
                            <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-white/60 group-hover:text-white group-hover:bg-violet-500/20 transition-all duration-300">
                                {contact.icon}
                            </div>
                ...
                >
                    <a
                        href="mailto:daivikreddy1520@gmail.com"
                ...
                <div className="text-center">
                    ...
                    <p className="text-white/20 text-sm mt-2">© {new Date().getFullYear()} — All rights reserved</p>
                </div>
            </div>
